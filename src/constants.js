...
export const SkillsInfo = [
  ...
  export const experiences = [
    ...
    // },
    {
      ...
      desc: "Worked as a Frontend Developer Intern, designing and implementing scalable UI components and responsive websites using HTML, CSS, JavaScript, Tailwind, and Material UI, user-friendly web pages.",
      skills: [
        "HTML",
        "CSS",
        "Javascript",
